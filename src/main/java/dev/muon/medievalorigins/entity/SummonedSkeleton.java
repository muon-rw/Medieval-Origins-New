...
public class SummonedSkeleton extends Skeleton implements SummonedMob {
    ...
    private static final EntityDataAccessor<Boolean> IS_LIMITED_LIFE =
            SynchedEntityData.defineId(SummonedSkeleton.class, EntityDataSerializers.BOOLEAN);
    private static final EntityDataAccessor<Integer> LIFE_TICKS =
            SynchedEntityData.defineId(SummonedSkeleton.class, EntityDataSerializers.INT);
